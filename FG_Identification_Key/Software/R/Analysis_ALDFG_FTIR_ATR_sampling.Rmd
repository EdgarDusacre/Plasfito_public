...
#Calculation of the total mass of waste on the 747.29 km of beach between nov2022 and nov2023

data_100m <- Global %>% filter(Year == 2023, Site != "Le Teich") %>% 
  filter(FG != "Unidentified rope", FG != "Unidentified net") %>% 
  group_by(Season, Site, Year) %>% summarise(sum_mass = sum(Weight)/1000) %>% #to get the data in kg
...
# Effectuer le bootstrap pour calculer la moyenne de la masse par 100m de plage
set.seed(123)  # Pour la reproductibilité
bootstrap_results <- boot(data_100m$mass, mean_fun, R = 10000)

# Calculer l'estimation pour tout le trait de côte
trait_cote_100m <- 747.29*1000/100 #x1000 to convert in m and /100 to know how many transects of 100m in 747.29 km
...
print(paste0("Estimation de la masse totale de déchets sur le trait de côte de 747.29 km : ",
             round(total_estimate, 2), "kg",
